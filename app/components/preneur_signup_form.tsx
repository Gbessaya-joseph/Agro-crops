...
import { googleSignup, facebookSignup, registerPreuneur } from "@/lib/actions/users";
...
export function PreneurSignupForm() {
//gerer l'etat du boutton
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await registerPreuneur(formData);
    } catch (error) {
    ...
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      <form className="my-8" onSubmit={handleSubmit} >
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="amakwatcha@gmail.com" type="email" name="email" required/>
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="type" placeholder="Preneur" type="text" name="type" required/>
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
